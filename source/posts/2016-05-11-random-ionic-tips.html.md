...
You can hook up any gulp tasks to `ionic serve` command. Triggering zannotate` and `watch` command is a good way of making sure that you always have the latest version of the app running in the browser.
