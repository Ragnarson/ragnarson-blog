...
And that was exactly the problem we discussed in this episode together with our guest - Tobias Matetschlaeger from [https://www.globalchanger.org/](Global Changer).

If you want to find out how you can play the role in reducing carbon emissions, check the video below.

<iframe width="100%" height="378" src="https://www.youtube.com/embed/fj9AKDNfTWY" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
